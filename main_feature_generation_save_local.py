"""
Script to load original csv, apply data cleaning, missing value imputing,
feature generation, scaling, cf scoring, and table merging, and fianlly output
tables to csv files for further steps

Streamline:
main_feature_generation_save_local.py (this file) -->
