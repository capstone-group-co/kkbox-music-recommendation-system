...
response = s3_client.get_object(
    Bucket="www.g43865368.gwu.edu", Key="full_train.csv")
...
# Train the Naive Bayes model according to training dataset Features
# and Targets
...
# Connect to the S3 bucket and select the file to import
response = s3_client.get_object(
    Bucket="www.g43865368.gwu.edu", Key="full_test.csv")
